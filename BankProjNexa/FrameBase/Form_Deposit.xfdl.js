(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("id_title_makeaccount","625.00","20","85","60",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("* 입  금 *");
            ...
            obj = new Edit("edtDepositAccId","173.00","28","220","35",null,null,null,null,null,null,this.divBox.form);
            obj.set_taborder("2");
            obj.set_font("normal 12pt/normal \"맑은고딕\"");
            this.divBox.addChild(obj.name, obj);

            obj = new Edit("edtDepositMoney","172.00","80","220","35",null,null,null,null,null,null,this.divBox.form);
            obj.set_taborder("3");
            obj.set_font("normal 12pt/normal \"맑은고딕\"");
            this.divBox.addChild(obj.name, obj);

            obj = new Button("btnDeposit","174.00","135","120","50",null,null,null,null,null,null,this.divBox.form);
            obj.set_taborder("4");
            obj.set_text("입 금");
            obj.set_font("normal 12pt/normal \"맑은고딕\"");
            obj.set_borderRadius("10px");
        ...
        // User Script
        this.registerScript("Form_Deposit.xfdl", function() {

        this.divBox_btnDeposit_onclick = function(obj,e)
        {
        	var id="deposit";
        ...
        {
            this.divBox.form.btnDeposit.addEventHandler("onclick",this.divBox_btnDeposit_onclick,this);
        };
        this.loadIncludeScript("Form_Deposit.xfdl");
